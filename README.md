## От себя
Разбил проект на слои, постарался реализовать контролы по патерну mvvm.
Хотел еще написать тесты, но не успел и еще пару вешей
надо еще порефачить viewmodel слой
